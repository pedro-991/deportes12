...
export default function Index() {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
     ...
     {/*  <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold text-gray-800">Jugadores</h1>
        <Link href="/admin/players/create" className="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md shadow-sm hover:bg-indigo-700">
          Registrar jugador
        </Link>
      </div> */}
